...
<body>
			...
			<div class="nav-content">
				...
				<h1>
					<a id="logo" class="logo" href="home.php">
						<img src="images/bakery.png" height = "150px" width = "150px" alt="" class="img-fluid"><span>Simply</span> Delicious
					</a>
				</h1>
				<!-- //logo -->
				<!-- nav -->
				...
				<div class="banner-left-w3">
					<div class="container">
						<div class="banner-info_agile_w3ls">
							<h5>Only Fresh From the Oven</h5>
							<h3 class="text-da mb-4">Tasty <span>Baked Goodness</span> </h3>
							<p>Be the first to buy the best oven fresh baked good near you </p>
							<a href="about.php" class="button-w3ls active mt-5">Read More
								<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
							</a>
							<a href="menu.php" class="button-w3ls mt-5 ml-2">Order Now
								<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
							</a>
						</div>
					</div>
			...
			<div class="col-lg-7 col-md-6 about-right-w3 text-right py-md-5">
				<div class="right-space py-xl-5 py-lg-3">
					<div class="title-section mb-4">
						...
						<h3 class="w3ls-title">Welcome to <span>Simply Delicious</span></h3>
					</div>
					<p class="about-text">Simply Delicious is a bakery just off madaraka on your way to Nairobi West. Simply Delicious bakery is a hidden gem waiting to be discovered by our buyers. A place where you can satisfy your sweet tooth with our freshly baked goods.</p>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="menu.php">
								<img class="card-img-bottom" src="images/croissants.jpg" height = "235px" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-0">
							<h5 class="blog-title card-title m-0"><a href="menu.php">Croissants</a></h5>
							<p class="mt-3">Scrumptious pastry on offer today!! Dont miss out on this amazing deal</p>
							<a href="menu.php" class="btn button-w3ls mt-4 mb-3">View More
								<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
							</a>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 mt-md-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="menu.php">
								<img class="card-img-bottom" src="images/sweetcake.jpg" height = "235px" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-0">
							<h5 class="blog-title card-title m-0"><a href="menu.php">Sweet Cake</a></h5>
							<p class="mt-3">Sweet and soft cake with sprinkles to cure that sweet tooth</p>
							<a href="menu.php" class="button-w3ls active mt-4 mb-3">View More
								<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
							</a>
						</div>
					</div>
				...
				<div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
					<div class="card border-0 med-blog">
						<div class="card-header p-0">
							<a href="menu.php">
								<img class="card-img-bottom" src="images/muffins.jpg" alt="Card image cap">
							</a>
						</div>
						<div class="card-body border border-top-0">
							<h5 class="blog-title card-title m-0"><a href="menu.php">Chocolate Chip Muffins</a></h5>
							<p class="mt-3">heavenly chocolately goodness that just melts in your mouth</p>
							<a href="menu.php" class="button-w3ls mt-4 mb-3">View More
								<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
							</a>
						</div>
					</div>
		...
		<div class="row no-gutters">
			<div class="col-md-6 p-0">
				<div class="blog-sec-w3">
					<div class="text-blog-w3 text-center p-2">
						<h4 class="text-wh mb-3"><a href="menu.php">Best Collection</a></h4>
						<p class="text-li">Simply goodies that you can eat any where any time</p>
						<a href="menu.php" class="button-w3ls active mt-5">Order Now
							<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
						</a>
					</div>
				</div>
			...
			<div class="col-md-6 p-0">
				<div class="blog-sec-w3 blog-sec-w3-2">
					<div class="text-blog-w3 text-center p-2">
						<h4 class="text-wh mb-3"><a href="menu.php">Organic Best</a></h4>
						<p class="text-li">Made with fresh cinnammon to add that extra touch</p>
						<a href="menu.php" class="button-w3ls active mt-5">Order Now
							<span class="fa fa-caret-right ml-1" aria-hidden="true"></span>
						</a>
					</div>
				...
				<div class="col-lg-5 w3pvt-lauits_banner_bottom_left">
					<div class="row">
						<div class="col-8 wthree_banner_bottom_grid_right text-right">
							<h4 class="mb-3"><a href="login.php">Delivery</a></h4>
							<p>Uber delivery straight to your home</p>
						</div>
				...
				<div class="col-lg-5 w3pvt-lauits_banner_bottom_left mt-lg-0 mt-4">
					<div class="row">
						...
						<div class="col-8 wthree_banner_bottom_grid_right">
							<h4 class="mb-3"><a href="login.php">Free & Easy Returns</a></h4>
							<p>If it was not what you ordered, the returns policy's got you covered</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-4 w3pvt-lauits_banner_bottom_left">
					<div class="row">
						<div class="col-8 wthree_banner_bottom_grid_right text-right pl-lg-0">
							<h4 class="mb-3"><a href="login.php">Online Order</a></h4>
							<p>All on our menu at the tip on your fingers. Only a click a way</p>
						</div>
				...
				<div class="col-lg-4 w3pvt-lauits_banner_bottom_left mt-lg-0 mt-4">
					<div class="row">
						...
						<div class="col-8 wthree_banner_bottom_grid_right pr-lg-0">
							<h4 class="mb-3"><a href="login.php">Mobile Support</a></h4>
							<p>Call anytime to get your order ready</p>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="subscribe-main py-5">
		<div class="container py-xl-5 py-3">
			...
			<img src="images/banner5.jpg" alt="" class="img-fluid sub-img">
		</div>
	</section>
	<!-- //newsletter -->
