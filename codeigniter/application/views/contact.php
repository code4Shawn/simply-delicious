						...
						<ul class="menu">
							...
							<li>
								...
								<ul>
									...
									<li><a class="drop-text" href="abot.php">Blog</a></li>
	...
	<section class="ab-info-main py-5" id="contact">
		<div class="container py-xl-5 py-lg-3">
			<div class="title-section text-center mb-md-5 mb-4">
				...
				<p class="titile-para-text mx-auto">Customer feedback is appreciated. Please get back to us.</p>
			</div>
				...
				<div class="col-md-5 address">
					...
					<div class="row address-info-w3ls my-2">
						...
						<div class="col-9 address-right mt-2">
							...
							<p>
								<a href="mailto:example@email.com">info@simplydelicious.com</a>
							</p>
						</div>
					</div>
					<div class="row address-info-w3ls">
